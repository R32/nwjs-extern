...
extern class Menu {
	...
	function new( ?option : {type : MenuTypes} );
	...
	function createMacBuiltin( appname : String, ?options : {?hideEdit : Bool, ?hideWindow : Bool} ) : Void; // Mac
}

extern enum abstract MenuTypes(String) to String{
	var MENUBAR = "menubar";
